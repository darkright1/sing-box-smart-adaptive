...
func registerOpenConnectEndpoint(registry *endpoint.Registry) {
	endpoint.RegisterUnsupported[option.OpenConnectEndpointOptions](registry, C.TypeOpenConnect, func(ctx context.Context, router adapter.Router, logger log.ContextLogger, tag string, options option.OpenConnectEndpointOptions) (adapter.Endpoint, error) {
		if !options.System {
